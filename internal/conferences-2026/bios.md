...
Four lengths. First person. "Boubacar" only. No em-dashes. No hype. Truth-only.

---

## 1-line (60 chars max)

Use for: short intros, conference website speaker grid, Twitter bio line.

```
Boubacar builds AI workflow stacks for solo operators.
```
...
Use for: AI Tinkerers SLC speaker card, AfroTech short-form bio field.

```
I am Boubacar. I build AI workflow stacks for solo consultants and small business operators who want the leverage of a full team without the headcount.
...
Use for: MicroConf Europe speaker abstract field, long-form bio, About pages, podcast prep sheets.

```
I am Boubacar. I build AI workflow stacks for solo consultants and small business operators.

The work has two sides. The visible side is Catalyst Works, an AI consultancy where I rewrite the surfaces of a business that get judged before anyone talks to the owner. The LinkedIn headline that decides whether a buyer DMs. The website hero that decides whether they stay six seconds or thirty. The About page that turns a referral into a call.

The invisible side is the system underneath. I run a self-hosted multi-agent stack on a private VPS that handles research, drafting, scheduling, and publishing across five brands I operate solo. The same engine that produces my own marketing also delivers client work. I document the build openly because the stack is meant to be transferable to other operators, not locked behind a vendor wall.
...
(1490 chars / ~245 words)

---

## Voice notes

- "Boubacar" never "Boubacar Barry" in body text. Last name OK in formal venue listings if the venue requires legal name.
- "I am" not "I'm" in formal bios. Contractions OK in the 1-line and 3-line if space pressure forces it.
